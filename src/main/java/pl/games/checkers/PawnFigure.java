...
public class PawnFigure extends StackPane implements Pawn {
    ...
    public PawnFigure(PawnType type, Position position, boolean isKing) {
        ...
        Shape firstRoundel = createRoundel(type.color, PAWN_SIZE_Y);
        Shape secondRoundel = createRoundel(type.color, 0);
    ...
    public void setKing() {
        reference.setKing();
        Shape thirdRoundel = createRoundel(getType().color, -PAWN_SIZE_Y);
